...
global LoadIDT ;void LoadINT(uint16_t linit, uint64_t offset)
LoadIDT:
    push rbp
    mov rbp, rsp
    sub rsp, 10
...
global CallApp
CallApp: ;CallApp(int argc, char** argv, uint16_t ss, uint64_t rip, uint64_t rsp, uint64_t* os_stack_ptr);
    push rbx
    push rbp
    push r12
    push r13
